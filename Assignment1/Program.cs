...
//            while (selectedOption.CompareTo("10") != 0 || selectedOption.CompareTo("q") != 0 || selectedOption.CompareTo("Q") != 0 || selectedOption.CompareTo("quit") != 0 || selectedOption.CompareTo("Quit") != 0|| selectedOption.CompareTo("exit") != 0 || selectedOption.CompareTo("Exit") != 0)
//            {
//                PrintMainMenu();
...
//        //            reader = inFile.Read().ToString();
//        //            {
//        //                //string[] reader_String = reader.Split(' ');
//        //                /*
//        //                playerName = new string((from c in reader where char.IsWhiteSpace(c) || char.IsLetter(c) select c).ToArray());
//        //                readNumbers = new string((from c in playerName where char.IsDigit(c) select c).ToArray());
//        //                id = new string((from c in reader where char.IsDigit(c) select c).ToArray());
//        //                string[] splitNumbers = readNumbers.Split(' ');
//        //                foreach (string s in splitNumbers)
//        //                {
//        //                    System.Console.WriteLine("ID = {0, -20}", splitNumbers);
//        //                }*/
//        //                //Player player = new Player(id:);

//        //                //System.Console.WriteLine(" Name: {0, -20} Race: {1, -10} Level: {2, -10} Guild: {3, -10}", playerName, 7, 3, 4);
//        //            }
//        //            char[] input_arry = reader.ToCharArray();
//        //            string[] currentString = new string[] { };
//        //            foreach (char ch in input_arry)
//        //            {
...
//        //                    if (readingID == true)
//        //                    {
//        //                        idString = currentString[0];
//        //                        currentString[0] = idString.ToString();
//        //                        readingID = false;
//        //                        readingName = true;
//        //                    }
//        //                    else if (readingName == true)
//        //                    {
//        //                        nameString = currentString[1];
//        //                        currentString[ch] = nameString.ToString();
//        //                        System.Console.Write("Name: {0: -20}", currentString[1]);
//        //                        System.Console.Write("Name: {0: -20}", nameString);
//        //                        readingName = false;
//        //                        readingRace = true;
//        //                    }
//        //                    else if (readingRace)
//        //                    {
//        //                        raceString = currentString.ToString();
//        //                        currentString[2] = raceString.ToString();
//        //                        //raceString = currentString.ToString();
//        //                        //System.Console.Write("Level: {0: 10}", raceString);
//        //                        readingRace = false;
//        //                        readingLevel = true;
//        //                    }
//        //                    else if (readingLevel)
//        //                    {
//        //                        levelString = currentString.ToString();
//        //                        currentString[3] = levelString.ToString();

//        //                        //System.Console.Write("Level: {0: -10}", levelString);
//        //                        readingLevel = false;
//        //                        readingExp = true;
//        //                    }
//        //                    else if (readingExp)
//        //                    {
//        //                        expString = currentString.ToString();
//        //                        readingExp = false;
//        //                        readingGuild = true;
//        //                    }
//        //                    else if (readingGuild)
//        //                    {
//        //                        guildString = currentString.ToString();
//        //                        //System.Console.Write("Level: {0: -10}", guildString);
//        //                        readingGuild = false;
//        //                        readingGear0 = true;
//        //                    }
//        //                    else if (readingGear0)
//        //                    {
//        //                        gear[0] = Convert.ToUInt32(currentString.ToString());
//        //                        readingGear0 = false;
//        //                        readingGear1 = true;
//        //                    }
//        //                    else if (readingGear1)
//        //                    {
//        //                        gear[1] = Convert.ToUInt32(currentString.ToString());
//        //                        readingGear1 = false;
//        //                        readingGear2 = true;
//        //                    }
//        //                    else if (readingGear2)
//        //                    {
//        //                        gear[2] = Convert.ToUInt32(currentString.ToString());
//        //                        readingGear2 = false;
//        //                        readingGear3 = true;
//        //                    }
//        //                    else if (readingGear3)
//        //                    {
//        //                        gear[3] = Convert.ToUInt32(currentString.ToString());
//        //                        readingGear3 = false;
//        //                        readingGear4 = true;
//        //                    }
//        //                    else if (readingGear4)
//        //                    {
//        //                        gear[4] = Convert.ToUInt32(currentString.ToString());
//        //                        readingGear4 = false;
//        //                        readingGear5 = true;
//        //                    }
//        //                    else if (readingGear5)
//        //                    {
//        //                        gear[5] = Convert.ToUInt32(currentString.ToString());
//        //                        readingGear5 = false;
//        //                        readingInventory0 = true;
//        //                    }
//        //                    else if (readingInventory0)
//        //                    {
//        //                        inventory.Add(Convert.ToUInt32(currentString.ToString()));
...
//        //                    }
//        //                    //System.Console.Write("Name: {0: -20}", nameString);
//        //                    //uint id = Convert.ToUInt32(idString);
//        //                    //Race racial = ((Race)Convert.ToUInt32(raceString));
//        //                    //uint lv = Convert.ToUInt32(levelString);
//        //                    //uint e = Convert.ToUInt32(expString);
//        //                    //uint g = Convert.ToUInt32(guildString);
//        //                    //Player player = new Player(id: idString, name: nameString, race: (Race)3, level: levelString, exp: expString, guildId: guildString, gear: gear, inventory: inventory);

//        //                    Player player = new Player(Convert.ToUInt32(id), nameString, race: racial , level: lv, exp: e, guildId: g, gear: gear, inventory: inventory);
//        //                    //System.Console.WriteLine("Name: {0: -20} Race: {1: -10} Level: {2: -10} Guild: {3: -10}", nameString, raceString, levelString, guildString);
//        //                    //System.Console.WriteLine("Name: {0: -20} Race: {1: -10} Level: {2: -10} Guild: {3: -10}", currentString[ch], currentString[ch], currentString[ch], currentString[ch]);
//        //                    System.Console.Write(currentString);
//        //                    //currentString = new StringBuilder(); // To empty the String Builder. 
//        //                }
//        //                else
//        //                {
//        //                    currentString[ch] = currentString.ToString();
//        //                    //System.Console.Write(input_arry[20]);
//        //                }
//        //            }
//        //        }
//        //    }
...
//        //    if (ConcurrentExclusiveSchedulerPair<(Level* 1000)) {
...
//            {
//                System.Console.WriteLine("Player is playing hard to get! " + P.ToString());
//            }
...
//                        //guild = new string((from c in reader where char.IsLetter(c) select c).ToArray());
...
namespace Assignment1
{
    ...
    public class Player : IComparable
    {
        ...
        {
            return "Name: " + name + "\t Race: " + race + "\t Level: " + level + "\t Guild: " + guildID;
        }
    }
    public class Item : IComparable
    {
    ...
    public class Program
    {
        ...
        public static void PrintAllPlayers()
        {
            ...
            {
                System.Console.WriteLine("Player is playing hard to get! " + Pla.ToString());
            }
